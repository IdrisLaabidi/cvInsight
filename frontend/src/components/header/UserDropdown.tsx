        ...
        <div className="relative">
            ...
            >
                ...
                <div className="mr-3 flex h-11 w-11 items-center justify-center rounded-full bg-blue-600 text-white font-semibold text-lg">
                    {getInitials(auth.userProfile?.firstName, auth.userProfile?.lastName)}
                </div>
            ...
            <Dropdown
                ...
                className="absolute right-0 mt-2 flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-lg dark:border-gray-800 dark:bg-gray-dark"
            >
                {/* User Info */}
                <div className="mb-4">
          <span className="block font-medium text-gray-700 dark:text-gray-400">
            ...
            {auth.user?.email || "johndoe@example.com"}
                ...
                {/* Dropdown Actions */}
                <ul className="flex flex-col gap-1 border-b border-gray-200 dark:border-gray-800 pb-3">
                    <li>
                        <DropdownItem
                ...
                <DropdownItem
                    onClick={auth.logout}
                    className="flex items-center gap-3 px-3 py-2 mt-3 font-medium text-gray-700 rounded-lg group text-sm hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-white/5"
                >
